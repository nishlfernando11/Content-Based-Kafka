...
class AdminManager(val config: KafkaConfig,
  ...
  // method handle client interests in admin manager
  def handleSendInterests(clientId: String, connectionId: String, interests: String, responseCallback: Short => Unit) {

    println("Started handle interests "+connectionId+" "+interests)
    ConsumerGroupInterests.processConsumerInterests(connectionId, clientId, interests)
    //val details = ConsumerGroupInterests.getGroupInterests(connectionId)
    println(ConsumerGroupInterests.interestContainer)
