...
public class Protocol {
    ...
    /* send interests api */
    public static final Schema SEND_INTERESTS_REQUEST_V0 = new Schema(new Field("group_id", STRING, "The group id."),
            new Field("interests", STRING, "Client defined interests"));

    public static final Schema SEND_INTERESTS_RESPONSE_V0 = new Schema(new Field("error_code", INT16));

    public static final Schema[] SEND_INTERESTS_REQUEST = new Schema[] {SEND_INTERESTS_REQUEST_V0};
    public static final Schema[] SEND_INTERESTS_RESPONSE = new Schema[] {SEND_INTERESTS_RESPONSE_V0};
    ...
    static {
        ...
        REQUESTS[ApiKeys.SEND_INTERESTS.id] = SEND_INTERESTS_REQUEST;
        ...
        RESPONSES[ApiKeys.SEND_INTERESTS.id] = SEND_INTERESTS_RESPONSE;
