...
public class FileRecords implements Records {
    ...
    //flag for content filtering enable for this record set
    boolean contentEnable = false;
    //consumer id regarding this record set
    FilteringContent filterContent = null;
    ...
    public long writeTo(GatheringByteChannel destChannel, long offset, int length) throws IOException {
        ...
        if(isContentEnable()){
            System.out.println("Content enable in file records");
            if (destChannel instanceof TransportLayer) {
                TransportLayer tl = (TransportLayer) destChannel;
                return tl.transferFromWithFiltering(this.channel, position, count, getFilteringContent());
            } else {
    ...
    public FilteringContent getFilteringContent(){
    ...
    public void setFilteringContent(FilteringContent contentId){
